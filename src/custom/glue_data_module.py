...
class GLUEDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        ...
        train_dataset = train_dataset.add_column("weights", self.weights) # add weights to train dataset

        # Prepare validation and test dataset
        column_names = train_dataset.column_names; column_names.remove("weights")
    ...
    def update_weights(self, alpha, masks):
        ...
        self.train_dataset = self.train_dataset.remove_columns("weights")
        self.train_dataset = self.train_dataset.add_column("weights", self.weights)
